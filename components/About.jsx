     ...
     id='about' className='w-full mt-16 md:h-screen py-16 p-2 flex justify-center items-center '>
        <div className='px-5 max-w-[1240px] md:grid grid-cols-3 gap-6'>
            ...
            <div className="items-center col-span-2 pt-5">
                <p className='py-2 text-white'>As a Web Developer and Data Analyst, I have a deep passion for creating user-oriented websites and applications that provide a seamless user experience. I have honed my skills in web development using frameworks such as ReactJS and NextJS and in Data Analyst using Python, SQL, Power BI. I am also well-versed in Data Structures and Algorithms which allows me to develop efficient and scalable solutions.</p>
                ...
                <p className='py-2 text-white'>My curiosity and enthusiasm drive me to continuously improve my skills and knowledge in web  development and data analayst. I am always eager to explore new technologies and ideas that can enhance my work and deliver even better results for my clients.</p>
