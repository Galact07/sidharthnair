...
const MainBody = () => {
  ...
  return (
    ...
    animate='visible'
    exit='exit'
    id='mainBody' className="w-full h-screen ">
        ...
        <div className='max-w-[1140px] w-full h-full m-auto px-4 py-2 flex z-10 justify-center items-center relative'>
           ...
           <h2 className='py-4 text-5xl text-white stroke-1 stroke-white relative'>Hey,  
           <span className='text-[#5651e5]'> Sid</span> here!</h2>
  ...
  className='mt-16 flex  justify-center items-center max-w-[330px]  py-6 gap-8 snap-center'>
